    ...
    <section className="py-24 px-6 relative overflow-hidden bg-background">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-heading font-black mb-6 italic uppercase tracking-tight text-white">
            The Magic of <span className="text-accent not-italic">Automation</span>.
          </h2>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto font-body font-light">
            From a simple text prompt to a production-ready <br className="hidden md:block" />
            intelligent system in 24 hours.
          </p>
        </div>
        ...
        <div 
          ...
          role="slider"
          aria-label="Prompt and UI comparison slider"
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-surface p-8 md:p-20">
            <div className="max-w-md w-full space-y-4">
              ...
              <div className="font-mono text-xs sm:text-sm md:text-base text-gray-400 leading-relaxed">
                <span className="text-accent">request:</span> I want a mobile application that also runs on the WEB. It should have a marketplace like Amazon, local services catalog, and news automatically compiled from Telegram channels.
                <motion.span 
                  animate={{ opacity: [1, 0] }}
            ...
            <div className="absolute inset-0 flex items-center justify-center p-2 sm:p-4 md:p-8 overflow-hidden text-black font-sans">
              ...
              <div className="w-[320px] h-[580px] bg-white border-[8px] border-black rounded-[40px] shadow-2xl flex flex-col overflow-hidden relative scale-[0.75] sm:scale-90 md:scale-100 transition-transform duration-500">
                ...
                <div className="flex justify-around px-2 mb-4">
                  {['Services', 'Shops', 'Products'].map(item => (
                ...
                <div className="flex-1 overflow-y-auto px-4 space-y-6 pb-10">
                  ...
                  <div className="bg-white border border-gray-100 rounded-2xl p-4 flex items-center justify-between shadow-sm">
                    ...
                    <div className="text-blue-600 font-black text-lg uppercase">All Services</div>
                  </div>

                  {/* Events */}
                  <div className="space-y-3">
                    <div className="flex justify-between items-center px-1">
                      <h3 className="font-bold text-lg">Events <span className="text-blue-600 font-normal">all</span></h3>
                    </div>
                    <div className="flex gap-3">
                      <div className="flex-1 space-y-2">
                        <div className="aspect-[4/3] bg-blue-100 rounded-xl relative overflow-hidden">
                          <div className="absolute top-2 left-2 bg-white/90 px-2 py-1 rounded-md text-[9px] font-bold">Mar 25</div>
                          <div className="w-full h-full flex items-center justify-center text-2xl">🧠</div>
                        </div>
                        <p className="text-[10px] font-bold leading-tight line-clamp-2">Expat English Quiz...</p>
                      </div>
                      <div className="flex-1 space-y-2">
                        <div className="aspect-[4/3] bg-black rounded-xl relative overflow-hidden">
                          <div className="absolute top-2 left-2 bg-white/90 px-2 py-1 rounded-md text-[9px] font-bold">Mar 26</div>
                          <div className="w-full h-full flex items-center justify-center text-xs font-black text-white">IMbusiness</div>
                        </div>
                        <p className="text-[10px] font-bold leading-tight line-clamp-2">Free Business Session...</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center px-1">
                      <h3 className="font-bold text-lg">Shops <span className="text-blue-600 font-normal">all</span></h3>
                    </div>
                    <div className="flex gap-4">
                      <div className="text-center space-y-2">
                        ...
                        <p className="text-[9px] font-bold">Brazilian Coffee</p>
                      </div>
                      <div className="text-center space-y-2">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center px-1">
                      <h3 className="font-bold text-lg">Local News <span className="text-blue-600 font-normal">all</span></h3>
                    </div>
                    <div className="bg-white border border-gray-100 p-3 rounded-xl shadow-sm">
                      <p className="text-[10px] leading-snug font-medium">AFIP announced the increase of Monotributo income limits.</p>
                    </div>
                  </div>
                </div>
